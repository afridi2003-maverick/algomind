...
export default function Debugger({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-gray-900/60 border border-gray-800 rounded-xl p-5 backdrop-blur shadow-2xl">
      ...
      <div className="flex flex-col gap-3 border-b lg:border-b-0 lg:border-r border-gray-800/80 pb-5 lg:pb-0 lg:pr-5">
        ...
        <div className="flex-1 flex flex-col justify-center bg-black/35 rounded-lg p-4 border border-gray-800/50 min-h-[140px]">
          ...
          {algorithm === 'Kruskal' && (
            <div className="text-center">
              <span className="text-xs font-bold text-gray-500 block mb-2">MST EDGES (Union-Find / Sorted Edge List)</span>
              {mstEdges.length === 0 ? (
              ...
              {Object.keys(dsuParents).length > 0 && (
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center">
          ...
          <span className="text-[10px] font-mono text-gray-500 bg-black/40 px-2 py-0.5 rounded border border-gray-800">
        ...
        <div className="flex-1 bg-black/50 border border-gray-800/80 rounded-lg p-3 font-mono text-xs flex flex-col justify-between gap-3 min-h-[140px]">
          <div className="flex-1 flex flex-col gap-2">
            ...
            <p className="text-gray-200 leading-relaxed font-semibold italic text-sm">{message}</p>
          </div>
